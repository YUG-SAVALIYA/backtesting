...
for s in filtered_signals:
    ...
    if not fails:
        # Pre-final passed! Apply close_lf_replay
...
for s in accepted_signals:
    ...
    if thit:
        ...
        # If it hit SL but has positive return, it's a trailing SL winner, NOT a failure stoploss hit.
        if ret > 0:
