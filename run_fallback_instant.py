...
candidate_symbols = ['APEXECO', 'CARBORUNIV', 'CONSOFINVT', 'FCL', 'GUFICBIO', 'KAMDHENU', 'KERNEX', 'MODISONLTD', 'OMNI', 'ONELIFECAP', 'PURPLEUTED', 'RANEHOLDIN', 'SASKEN', 'SHREEJISPG', 'SSFL', 'VENUSREM']
    ...
    for sig in valid_sigs:
        ...
        if df_5m is not None:
            ...
            if not day1_5m.empty:
                ...
                # If 15:20 bar was missing in 5m CSV, fallback to last available bar of the day or daily close
...
print("=== TRADESIGNAL MATCHED WITH DAILY FALLBACK FOR MISSING 5M BARS ===")
