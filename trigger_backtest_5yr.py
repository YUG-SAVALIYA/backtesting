...
payload['start_date'] = '2021-06-15'
payload['end_date'] = '2026-07-28'
...
print('Sending request to backtest API for 2021-06-15 to 2026-07-28...')
try:
...
print('Running calc_stats_real.py to get realistic metrics...')
subprocess.run(['python', 'calc_stats_real.py'])
