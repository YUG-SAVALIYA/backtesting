...
# Configure Strategy Settings: Profit=20%, SL=5%, Book 50% at 10%, LTF 65-90, HTF 65-85 (W-FRI), ADX>=26, Range 3-8%
...
# Candidate symbols involved in our backtest period
candidate_symbols = ['APEXECO', 'CARBORUNIV', 'CONSOFINVT', 'FCL', 'GUFICBIO', 'KAMDHENU', 'KERNEX', 'MODISONLTD', 'OMNI', 'ONELIFECAP', 'PURPLEUTED', 'RANEHOLDIN', 'SASKEN', 'SHREEJISPG', 'SSFL', 'VENUSREM', 'AEGISLOG', 'BIKEWO', 'HONASA', 'RUBICON']
...
for sym in candidate_symbols:
    ...
    for sig in valid_sigs:
        ...
        # Filter 3:20 PM candles for subsequent trading days
...
print("=== TRADESIGNAL EVALUATED STRICTLY ON 3:20 PM CANDLES (2026-06-15 to 2026-07-28) ===")
