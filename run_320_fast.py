...
for sym in symbols:
    ...
    for sig in valid_sigs:
        ...
        # Check 3:20 PM candles for subsequent days
...
print(df_res[['symbol', 'signal_date', 'entry_date', 'entry_price', 'exit_price', 'exit_reason', 'partial_10pct_taken', 'pnl_pct']].to_string())
